...
FAST="cross_rank relayout terrain near mazefit mazevertex stubs hints vert vertpack mapwipe onroom guesscheck shearall export special_draw special_dock cmd_dir view marks nmp"
